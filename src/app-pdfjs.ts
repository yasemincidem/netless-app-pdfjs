...
export interface PDFjsAppOptions extends Pick<PDFViewerOptions, "pdfjsLib" | "workerSrc" | "scale" | "hidpi" | "maxSize" | "preview" | "previewScale" | "onRenderError" | "urlInterrupter" | "rangeChunkSize"> {
